...
# A for loop is a loop that use the for function and use square brackets.
# 2. What is the difference between a FOR loop and a WHILE loop?
# Provide two (2) examples of each. 
#A while loop runs indefinately but a for loop doesn't.
#While loop-A printer and stop light

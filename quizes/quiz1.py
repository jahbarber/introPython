...
A variable is a number used in programs
# 2. Name three (3) operators we've learned about in class and describe 
# a situation where you would use each one. 
Three operaters are arithmetic operators:when you need to perform common mathrmatical operators, Comparison operators:when you need to compare values, and Logical operators:when you need to compare true and false values.
# 3. Describe the difference between camal case and pascal case.
Every word except the first word starts with a capital letter in camel case and in pascal case every word starts with a capital letter
...
The boolean data type is the best to be used in this scenario. Glutenallergy=true or Glutenallergy=false
# 9. In your own words, describe what a program is?
 A program is the way people make certain apps
# 10. Describe the difference between a float and an integer.
A float is a number that has a decimal and an integer is any whole number.
